...
echo_and_run cd "/home/ziye01/kinova_mvig/src/kinova_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ziye01/kinova_mvig/src/kinova_client/setup.py" \
     \
    build --build-base "/home/ziye01/kinova_mvig/build/kinova_client" \
    install \
    --root="${DESTDIR-/}" \
